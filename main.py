...
game_back_button = button.Button(100, 910, back_img, 2)

iesniegt_button = button.Button(720, 500, iesniegt_img, 2, iesniegt_hover_img, 30)
restartet_button = button.Button(720, 590, restartet_img, 2, restartet_hover_img, 35)
...
def handle_resize(width, height):
    ...
    game_back_button = button.Button(
        int(100 * current_scale), int(910 * current_scale), back_img, button_scale
    )
    ...
    restartet_button = button.Button(
        int(720 * current_scale),
        int(590 * current_scale),
        restartet_img,
        button_scale,
        restartet_hover_img,
        int(35 * current_scale),
    )
...
while run:
    ...
    scroll_offset = int(
        scrollbar.scroll_percent * (scroll.get_height() - SCREEN_HEIGHT)
    )
